...
const clientSchema = new mongoose.Schema({
  ...
  zendesk_tickets: [{
    ...
    ticket_type: {
      type: String,
      enum: ['portal_access', 'glaeubieger_process', 'creditor_contact', 'payment_review', 'main_ticket', 'creditor_review', 'additional_creditor_review', 'late_upload_manual_review']
    },
