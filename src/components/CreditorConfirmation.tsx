  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      ...
      <div className="mt-12 flex flex-col space-y-4">
        ...
        {/* Additional Documents Upload Button - ITERATIVE LOOP FEATURE */}
        <div className="flex justify-center">
          <button
            onClick={() => {
              // Scroll to upload component at the top
              window.scrollTo({ top: 0, behavior: 'smooth' });
            }}
            className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg text-base font-semibold transition-colors duration-200 shadow-sm hover:shadow-md"
          >
            <span className="flex items-center justify-center space-x-2">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
              </svg>
              <span>Weitere Gläubigerdokumente hochladen</span>
            </span>
          </button>
        </div>
        ...
        <p className="text-sm text-gray-600 text-center px-4">
          Falls Ihnen noch Gläubiger fehlen, können Sie jederzeit weitere Dokumente hochladen.
          Unser Team wird diese prüfen und Ihnen eine aktualisierte Liste zur Bestätigung zusenden.
        </p>
      </div>
    </div>
  );
