  ...
  const handleReset = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setErrors({});
        console.log('✅ Client data reset successfully');
      } else {
        console.error('❌ Failed to reset client data:', response.data.error);
        setErrors({
          submit: 'Fehler beim Zurücksetzen der Daten'
        });
      }
    } catch (error: any) {
